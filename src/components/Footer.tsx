...
import WhiteLogo from "../assets/images/ManicroLogo.svg";
    ...
    return [
      {
        label: "LitePaper",
        path: "",
        link: "https://Manicro.com/wp-content/uploads/2023/01/Manicro-Lite-Paper-v3-1.pdf",
      },
      {
        label: "Pitch Deck",
        path: "",
    ...
    <div className="relative bottom-0 w-full">
      <div className="flex justify-between mx-20 mt-40">
        <div className="flex flex-col justify-center">
          <a className="w-full h-full" href="https://Manicro.com">
      ...
      <div className="flex w-full mb-10">
        <div className="flex justify-center w-full text-lg text-white">
          <a className="opacity-50" href="https://Manicro.com">
            © Manicro
          </a>
        </div>
      </div>
